...
private fun englishContent() = HelpContent(
    appPitch = "A real-time AR cat-ear camera for Android. Photorealistic ears follow your face.",
    ...
    features = listOf(
        "6 photorealistic ear styles — Classic, Sharp Feline, Rounded, Lynx Tufted, Dense Fluffy and Fox",
    ...
    howToUseSteps = listOf(
        ...
        "Use Party Mode for group selfies; tap re-roll to reshuffle everyone's ear style",
...
private fun germanContent() = HelpContent(
    appPitch = "Eine Echtzeit-AR-Katzenohren-Kamera für Android. Fotorealistische Ohren folgen deinem Gesicht.",
    ...
    features = listOf(
        "6 fotorealistische Ohrenstile — Klassisch, Scharf Felinartig, Gerundet, Luchs, Flauschig und Fuchs",
    ...
    howToUseSteps = listOf(
        ...
        "Party Mode für Gruppen-Selfies nutzen; neu würfeln mischt alle Ohrenstile neu",
...
private fun croatianContent() = HelpContent(
    appPitch = "Android kamera s AR mačjim ušima u stvarnom vremenu. Fotorealistične uši prate tvoje lice.",
    ...
    features = listOf(
        "6 fotorealističnih stilova ušiju — Klasične, Oštre mačje, Zaobljene, Risove, Gusto čupave i Lisičje",
    ...
    howToUseSteps = listOf(
        ...
        "Uključi Party Mode za grupne selfije; re-roll svima promiješa stil ušiju",
...
private fun mandarinContent() = HelpContent(
    appPitch = "一款Android实时增强现实猫耳相机。写实猫耳会跟随您的面部移动。",
    ...
    featuresTitle = "功能特性",
    features = listOf(
        "6种写实耳朵样式——经典、尖锐猫型、圆润、猞猁、浓密蓬松和狐狸",
        "流畅的实时动画，跟随头部运动",
