...
2. Tune overlay placement constants (width ratio, ear height) against real faces — use WP 17 overlay lab first.
...
6. Consider instrumented (androidTest) coverage for camera/ML Kit paths currently excluded from Kover.
